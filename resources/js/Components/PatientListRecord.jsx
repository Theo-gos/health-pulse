                ...
                <Stack spacing={6}>
                    ...
                    >
                        ...
                        >
                            <Box
                                ...
                                borderRadius={'xl'}
                            >
                                <Box color={'gray.500'} fontSize={'9px'}>Drug</Box>
                                <Stack
                                    w={'100%'}
                                    mt={'2px'}
                            ...
                            <Box
                                ...
                                borderRadius={'xl'}
                            >
                                <Box color={'gray.500'} fontSize={'9px'}>Food</Box>
                                <Stack
                                    w={'100%'}
                                    mt={'2px'}
                            ...
                            <Box
                                ...
                                borderRadius={'xl'}
                            >
                                <Box color={'gray.500'} fontSize={'9px'}>Environmental</Box>
                                <Stack
                                    w={'100%'}
                                    mt={'2px'}
                    ...
                    >
                        ...
                        <Stack
                            ...
                            overflowY={'scroll'}
                        >
                            <TestResultList data={medicalInfo} width={'100%'} />
                        </Stack>
                    </Box>
                </Stack>
            }
